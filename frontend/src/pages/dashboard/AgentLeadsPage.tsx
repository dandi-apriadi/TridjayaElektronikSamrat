      ...
      <motion.div variants={iv} className="glass-card rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="space-y-3">
          {paginated.map((lead: Lead) => {
            ...
            const waText = encodeURIComponent(`Halo ${lead.customerName}, saya dari Tridjaya Group. Saya ingin menindaklanjuti ketertarikan Anda pada ${lead.interestedProduct}. Ada yang bisa saya bantu?`);
            return (
