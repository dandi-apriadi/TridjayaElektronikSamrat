          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href={`https://wa.me/6285161542103?text=${encodeURIComponent(`Halo Tridjaya Group, saya tertarik dengan promo ${promo.title}. Bagaimana cara klaimnya?`)}`}
                  target="_blank"
        ...
        <div className="container-custom text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="font-body text-body-lg text-on-surface-variant mb-12">
              Promo ini berlaku selama persediaan masih ada. Jangan lewatkan kesempatan untuk membawa pulang produk impian Anda dengan harga spesial dari Tridjaya Group.
            </p>
