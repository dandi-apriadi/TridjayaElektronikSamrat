  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (user.must_change_password) {
        ...
        toast.success('Login Berhasil', 'Selamat datang di Portal Internal Tridjaya Group.');
        navigate('/dashboard');
      }
    } catch (error) {
            ...
            <div className="glass-premium rounded-[2rem] p-6 md:p-8 shadow-neon-cyan-sm hover:shadow-neon-cyan-md transition-all duration-300 border border-white/5 overflow-hidden relative group">
              ...
              <div className="flex items-center justify-between gap-4 mb-6">
                <div className="flex items-center gap-3">
                  <img src={logoHorizontal} alt="Tridjaya Group" className="h-14 w-auto object-contain" />
                </div>
