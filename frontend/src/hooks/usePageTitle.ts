...
const ROUTE_TITLES: Record<string, string> = {
  ...
  '/dashboard/admin/sales': `Manajemen Sales — ${SITE}`,
  '/dashboard/admin/sales/referral': `Referral Sales — ${SITE}`,
  ...
  '/dashboard/admin/support': `Support Ticket — ${SITE}`,
  ...
  '/dashboard/agent/support': `Support — ${SITE}`,
